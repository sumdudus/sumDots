...
```
The waybar config features a tailscale module which requires you to log in atleast once. Also, if you don't want that module - remove it from the config [here](.config/waybar/config#52).
